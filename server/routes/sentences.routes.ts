...
// Get daily sentence
router.get("/api/sentences/daily", async (req: AuthRequest, res) => {
  try {
...
router.get("/api/sentences", async (req, res) => {
  try {
    ...
    if (search) {
      ...
      allSentences = allSentences.filter(s => 
...
// Create sentence
router.post("/api/sentences", requireAuth, async (req: AuthRequest, res) => {
  try {
...
// Update reading note
router.put("/api/sentences/:id/note", requireAuth, async (req: AuthRequest, res) => {
  try {
...
// Update sentence
router.put("/api/sentences/:id", requireAuth, async (req: AuthRequest, res) => {
  try {
    const id = parseInt(req.params.id);
...
// Delete sentence
router.delete("/api/sentences/:id", requireAuth, async (req: AuthRequest, res) => {
  try {
    const id = parseInt(req.params.id);
    const userId = req.session!.userId!;
...
router.post("/api/sentences/:id/like", requireAuth, async (req: AuthRequest, res) => {
  try {
    const id = parseInt(req.params.id);
    const userId = req.session!.userId!;
...
router.delete("/api/sentences/:id/like", requireAuth, async (req: AuthRequest, res) => {
  try {
    const id = parseInt(req.params.id);
    const userId = req.session!.userId!;
